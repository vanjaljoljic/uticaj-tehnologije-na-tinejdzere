<div id="post-<?php the_ID(); ?>" class=" <?php get_post_class() ?> wp-block wp-block-kubio-section  position-relative wp-block-kubio-section__outer ketos-page__k__p7Z7tbZgOg-outer ketos-local-895-outer d-flex h-section-global-spacing align-items-lg-center align-items-md-center align-items-center" data-kubio="kubio/section">
