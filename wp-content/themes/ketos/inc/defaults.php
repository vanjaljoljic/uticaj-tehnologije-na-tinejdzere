...
$ketos_theme_divider_style = array(
...
return array(
	'default_icon'                 => $ketos_theme_svg_icons['fort-awesome'],
	'icons'                        => $ketos_theme_svg_icons,
	'divider_style'                => $ketos_theme_divider_style,
	'lorem_ipsum'                  => $ketos_lorem_ipsum,
	'edit_this_text_in_customizer' => $ketos_theme_click_pen_to_edit_title,
	'gradients'                    => $ketos_gradients,
	...
	'front-header' => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $ketos_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $ketos_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $ketos_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'left',
		...
		'hero'         => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $ketos_gradients['night_fade'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
			...
			'image'             => array(
				...
				'localProps' => array(
					'url' => get_template_directory_uri() . '/resources/images/hero-media-right.png',
				),
			),
			'full_height'       => true,
		),
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $ketos_theme_svg_icons['facebook-square'],
						'link_value' => 'https://www.facebook.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $ketos_theme_svg_icons['instagram-square'],
						'link_value' => 'https://www.instagram.com/',
						'index'      => 1,
					),
					array(
						'icon'       => $ketos_theme_svg_icons['youtube-play'],
						'link_value' => 'https://www.youtube.com/',
						'index'      => 2,
					),
					array(
						'icon'       => $ketos_theme_svg_icons['reddit'],
						'link_value' => 'https://www.reddit.com/',
						'index'      => 3,
					),
				),
			),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $ketos_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $ketos_theme_svg_icons['phone'],
						'text'       => '+400 098 765 432',
						'link_value' => 'tel:+400 098 765 432',
						'index'      => 1,
					),
					array(
						'icon'       => $ketos_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					array(
						'icon'       => $ketos_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $ketos_theme_svg_icons['twitter'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $ketos_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $ketos_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					...
					array(
						'icon'       => $ketos_theme_svg_icons['phone-square'],
						'text'       => '+400 098 765 432',
						'link_value' => '#',
						'index'      => 1,
					),
	...
	'blog_post_thumb_placeholder_color' => 'rgb(243, 248, 252)',
