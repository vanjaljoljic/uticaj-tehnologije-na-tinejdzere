 ...
 */
Class The_Event_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class The_Event_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class The_Event_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="the-event-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @see WP_Customize_Control
 */
class The_Event_Icon_Picker_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="the-event-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'the-event' ); ?>" class="the-event-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
 ...
 * @since  1.0.0
 */
class The_Event_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
 ...
 * @see WP_Customize_Control
 */
Class The_Event_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @access public
 */
class The_Event_Customize_Section_Upsell extends WP_Customize_Section {
