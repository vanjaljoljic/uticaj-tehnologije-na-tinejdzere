...
class The_Event_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'the_event';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'the-event' ), $i ),
...
// Initialize.
$the_event_footer_widgets = new The_Event_Footer_Widgets();
