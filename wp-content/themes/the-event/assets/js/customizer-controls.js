...
jQuery( document ).ready(function($) {
    ...
    $(".the-event-chosen-select").chosen({
        width: "100%"
    });
    ...
    $( document ).on( 'click', '.customize_multi_add_field', the_event_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', the_event_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', the_event_customize_multi_remove_field )
    ...
    function the_event_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            the_event_customize_multi_write( $control );
    }

    function the_event_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        the_event_customize_multi_write( $control );
    }

    function the_event_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function the_event_customize_multi_write( $element) {
