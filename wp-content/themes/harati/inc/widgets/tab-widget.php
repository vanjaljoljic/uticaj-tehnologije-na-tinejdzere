...
class Harati_Tab_Posts extends Harati_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'widget_harati_tab_posts';
        $this->widget_description = __("Displays Tab Widget", 'harati');
        $this->widget_id = 'harati_tab_posts';
        $this->widget_name = __('Harati: Tab Posts', 'harati');
        $this->settings = array(
            'popular_heading' => array(
                'label' => esc_html__('Popular', 'harati'),
                'type' => 'heading',
            ),
            'popular_number' => array(
                'label' => esc_html__('No. of Posts:', 'harati'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'recent_heading' => array(
                'label' => esc_html__('Recent', 'harati'),
                'type' => 'heading',
            ),
            'recent_number' => array(
                'label' => esc_html__('No. of Posts:', 'harati'),
            ...
            'comments_heading' => array(
                'label' => esc_html__('Comments', 'harati'),
                'type' => 'heading',
            ),
            'comments_number' => array(
                'label' => esc_html__('No. of Comments:', 'harati'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'tagged_heading' => array(
                'label' => esc_html__('Tagged', 'harati'),
                'type' => 'heading',
            ),
            'select_image_size' => array(
                'label' => esc_html__('Select Image Size Featured Post:', 'harati'),
                'type' => 'select',
                'default' => 'medium',
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'harati'),
                    'medium' => esc_html__('Medium', 'harati'),
                    'large' => esc_html__('Large', 'harati'),
                    'full' => esc_html__('Full', 'harati'),
                ),
            ),
            'style' => array(
                'type' => 'select',
