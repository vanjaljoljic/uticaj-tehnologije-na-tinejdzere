...
$related_posts_text = harati_get_option('related_posts_text');
$no_of_related_posts = absint(harati_get_option('no_of_related_posts'));
$order = esc_attr(harati_get_option('related_posts_order'));
$orderby = esc_attr(harati_get_option('related_posts_orderby'));
