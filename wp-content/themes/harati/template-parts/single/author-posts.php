...
$author_posts_text = harati_get_option('author_posts_text');
$no_of_author_posts = absint(harati_get_option('no_of_author_posts'));
$order = esc_attr(harati_get_option('author_posts_order'));
$orderby = esc_attr(harati_get_option('author_posts_orderby'));
