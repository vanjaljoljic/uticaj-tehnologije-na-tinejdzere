...
{
	$option = get_option('flatmagazinews_themepage_seen');
	$awaiting = !$option ? ' <span class="awaiting-mod">1</span>' : '';
	$theme_info = add_theme_page(__('Theme Settings', 'flatmagazinews'), __('Theme Settings', 'flatmagazinews').$awaiting, 'manage_options', 'flatmagazinews-info.php', 'flatmagazinews_info_page', 1);
}
function flatmagazinews_info_page()
{
	...
	$theme_name = is_child_theme() ? $theme." ".__("and", "flatmagazinews")." ".$parent_name : $theme;
	$demo_text = is_child_theme() ? sprintf(__("Need inspiration? Take a moment to view our theme demo for the %s parent theme %s!", "flatmagazinews"), $theme, $parent_name) : __("Need inspiration? Take a moment to view our theme demo!", "flatmagazinews");
	$premium_text = is_child_theme() ? sprintf(__("Unlock all features by upgrading to the premium edition of %s and its parent theme %s.", "flatmagazinews"), $theme, $parent_name) : sprintf(__("Unlock all features by upgrading to the premium edition of %s.", "flatmagazinews"),$theme);
	$option_name = 'flatmagazinews_themepage_seen';
		...
		<div class="spt-theme-settings-wrapper">
			<div class="spt-theme-settings-wrapper-main-content">
				<div class="spt-theme-settings-tabs">
					...
					<div class="spt-theme-settings-tab">
						...
						<label class="spt-theme-settings-label" for="tab-1"><?php esc_html_e("Get started with", "flatmagazinews"); ?> <?php echo esc_html($theme_name); ?></label>
							...
							<div class="spt-theme-settings-content-getting-started-wrapper">
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Add Menus", "flatmagazinews"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('nav-menus.php'))  ?>"><?php esc_html_e("Go to Menus", "flatmagazinews"); ?></a>
									</div>
								</div>

								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Add Widgets", "flatmagazinews"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('widgets.php'))  ?>"><?php esc_html_e("Go to Widgets", "flatmagazinews"); ?></a>
									</div>
								</div>

								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Change Header Image", "flatmagazinews"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></a>
									</div>
								</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Upload Logo", "flatmagazinews"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></a>
									</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Change Background Color / Image", "flatmagazinews"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></a>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize All Fonts", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize All Colors", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Import Demo Content", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Demo Import", "flatmagazinews"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Contact Premium Support", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Unlock Full SEO Optimization", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Logo Container Background Image", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Only Show Header Image On Front Page", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Custom Text On Header Image", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize Header Image Height", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Unlock Elementor Compatibility", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Install Elementor", "flatmagazinews"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Access All Child Themes", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("View Child Themes", "flatmagazinews"); ?></span>
									</div>
								</a>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Add Recent Posts Widget", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Widgets", "flatmagazinews"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Only Show Upper Widgets On Front Page", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Custom Copyright Text", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Remove 'Tag' from tag page title", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Remove 'Author' from author page title", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Remove 'Category' from author page title", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Right/Left Sidebar", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Full Width Post / Page Template", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/flat-magazinews/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Toggle Full Content / Excerpt On Blog Fee", "flatmagazinews"); ?></span> <span><?php esc_html_e("Premium", "flatmagazinews"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "flatmagazinews"); ?></span>
									</div>
			...
			<div class="spt-theme-settings-wrapper-sidebar">
				...
				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Additional Resources", "flatmagazinews"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<ul>
							<li>
								<a target="_blank" href="https://wordpress.org/support/forums/"><span class="dashicons dashicons-wordpress"></span><?php esc_html_e("WordPress.org Support Forum", "flatmagazinews"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://www.facebook.com/superbthemescom/"><span class="dashicons dashicons-facebook-alt"></span><?php esc_html_e("Find us on Facebook", "flatmagazinews"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://twitter.com/superbthemescom"><span class="dashicons dashicons-twitter"></span><?php esc_html_e("Find us on Twitter", "flatmagazinews"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://www.instagram.com/superbthemes/"><span class="dashicons dashicons-instagram"></span><?php esc_html_e("Find us on Instagram", "flatmagazinews"); ?></a>
							</li>
				...
				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("View Demo", "flatmagazinews"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<p><?php echo esc_html($demo_text); ?></p>
						<a href="https://superbthemes.com/demo/flatmagazinews/" target="_blank" class="button button-primary"><?php esc_html_e("View Demo", "flatmagazinews"); ?></a>
					</div>
				</div>

				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Upgrade to Premium", "flatmagazinews"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<p><?php echo esc_html($premium_text); ?></p>
						<a href="https://superbthemes.com/flat-magazinews/" target="_blank" class="button button-primary"><?php esc_html_e("View Premium Version", "flatmagazinews"); ?></a>
					</div>
				</div>

				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Helpdesk", "flatmagazinews"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<p><?php esc_html_e("If you have issues with", "flatmagazinews"); ?> <?php echo esc_html($theme); ?> <?php esc_html_e("then send us an email through our website!", "flatmagazinews"); ?></p>
						<a href="https://superbthemes.com/customer-support/" target="_blank" class="button"><?php esc_html_e("Contact Support", "flatmagazinews"); ?></a>
					</div>
				</div>

				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Review the Theme", "flatmagazinews"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<p><?php esc_html_e("Do you enjoy using", "flatmagazinews"); ?> <?php echo esc_html($theme); ?><?php esc_html_e("? Support us by reviewing us on WordPress.org!", "flatmagazinews"); ?></p>
						<a href="https://wordpress.org/support/theme/<?php echo esc_attr(get_stylesheet()); ?>/reviews/#new-post" target="_blank" class="button"><?php esc_html_e("Leave a Review", "flatmagazinews"); ?></a>
					</div>
				</div>
...
function flatmagazinews_spbThemesNotification(){
	...
	$notifications->Add("flatmagazinews_notification", "Unlock All Features with Flat Magazinews Premium – Limited Time Offer", "
		...
		Take advantage of the up to <span style='font-weight:bold;'>40% discount</span> and unlock all features with Flat Magazinews Premium. 
		The discount is only available for a limited time.

		<div>
		<a style='margin-bottom:15px;' class='button button-large button-secondary' target='_blank' href='https://superbthemes.com/flat-magazinews/'>Read More</a> <a style='margin-bottom:15px;' class='button button-large button-primary' target='_blank' href='https://superbthemes.com/flat-magazinews/'>Upgrade Now</a>
		</div>
	...
	$notifications->Add("flatmagazinews_notification_start", "Let's get you started with Flat Magazinews!", '
		...
		<a href="https://superbthemes.com/demo/flatmagazinews/" target="_blank" class="button">View Flat Magazinews Demo <span aria-hidden="true" class="dashicons dashicons-external"></span></a> 

		</span>
		<span class="st-notification-column">
		<h2>Customize Flat Magazinews</h2>
		<ul>
		...
		Flat Magazinews is created by SuperbThemes. We have 100.000+ users and are rated <strong>Excellent</strong> on Trustpilot <img src="'. esc_url( get_template_directory_uri() . '/inc/admin_notification/src/stars.svg' ).'" width="87" height="16" />
		</span>
		</span>
