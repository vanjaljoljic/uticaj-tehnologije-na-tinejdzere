...
function shk_corporate_copyright_customizer( $wp_customize ) {
    ...
    $wp_customize->add_panel( 'appointment_copyright_setting', array(
    	...
    	'title'      => esc_html__('Footer Copyright Settings', 'shk-corporate'),
    ) );
    ...
    array(
        'default' => '<p>'.__( 'Proudly powered by <a href="https://wordpress.org">WordPress</a> | Theme: <a href="https://webriti.com" rel="nofollow">Shk Corporate</a> by Webriti', 'shk-corporate' ).'</p>',
    	'sanitize_callback' => 'shk_corporate_sanitize_html',
    	'type' =>'option'
    )
    ...
    $wp_customize->add_control(
        'appointment_options[footer_copyright_text]',
        array(
            'label' => esc_html__('Copyright Text','shk-corporate'),
    ...
    $wp_customize->add_setting(
        ...
        'default' => 0,
    	'sanitize_callback' => 'shk_corporate_sanitize_checkbox',
    	'type' => 'option'
    ));
    ...
    $wp_customize->add_control(
        ...
        array(
            'type' => 'checkbox',
            'label' => esc_html__('Hide copyright text','shk-corporate'),
            'section' => 'copyright_section_one',
        )
    );
	...
	$wp_customize->add_section(
        ...
        array(
            'title' => esc_html__('Social Links','shk-corporate'),
           'priority' => 45,
			'panel' => 'appointment_copyright_setting',
        )
    );
    ...
    'appointment_options[footer_social_media_enabled]',
    array(
        'label' => esc_html__('Hide footer social icons','shk-corporate'),
    ...
    'appointment_options[footer_social_media_facebook_link]',
    array(
        'label' => esc_html__('Facebook URL','shk-corporate'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Open link in new tab','shk-corporate'),
        'section' => 'copyright_social_icon',
    )
    );
    ...
    'appointment_options[footer_social_media_twitter_link]',
    array(
        'label' => esc_html__('Twitter URL','shk-corporate'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    'appointment_options[footer_social_media_linkedin_link]',
    array(
        'label' => esc_html__('LinkedIn URL','shk-corporate'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
   ...
   'appointment_options[footer_social_media_skype_link]',
    array(
        'label' => esc_html__('Skype URL','shk-corporate'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
...
function shk_corporate_sanitize_checkbox($checked) {
        // Boolean check.
        return ( ( isset($checked) && true == $checked ) ? 1 : 0 );
}
function shk_corporate_sanitize_html( $input ) {
