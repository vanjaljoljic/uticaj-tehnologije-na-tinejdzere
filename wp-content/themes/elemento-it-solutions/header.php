...
<header id="site-navigation" class="header text-center text-md-left py-2 <?php if( get_theme_mod( 'elemento_it_solutions_sticky_header',false) != '') { ?>sticky-header<?php } else { ?>close-sticky <?php } ?>">
	<div class="container">
		<div class="row">
