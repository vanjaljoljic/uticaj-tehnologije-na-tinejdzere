...
if ($appointment_news_setting['home_blog_enabled'] == 0 || $appointment_news_setting['home_blog_enabled'] == '') {
    ?>
    <div class="blog-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                <?php if( $appointment_news_setting['blog_heading'] != ''|| $appointment_news_setting['blog_description']!= '' ){ ?>
                    <div class="section-heading-title">
                    <?php if( $appointment_news_setting['blog_heading']) {?>
                        <h2><?php echo esc_html($appointment_news_setting['blog_heading']); ?></h2>
                    <?php } ?>
                    <?php if($appointment_news_setting['blog_description']){ ?>
