...
add_filter('wp_page_menu_args', 'appointment_page_menu_args1');
...
function webriti_fallback_page_menu($args = array()) {
    ...
    if (!empty($args['show_home'])) {
        if (true === $args['show_home'] || '1' === $args['show_home'] || 1 === $args['show_home'])
            $text = esc_html__('Home', 'appointment');
        else
            $text = $args['show_home'];
        $class = '';
    ...
    $list_args['title_li'] = '';
    $list_args['walker'] = new appointment_walker_page_menu1;
...
class appointment_walker_page_menu1 extends Walker_Page {
...
// code for child theme appoinment_nav_walker.php 
...
function appointment_nav_menu_css_class1( $classes ) {
