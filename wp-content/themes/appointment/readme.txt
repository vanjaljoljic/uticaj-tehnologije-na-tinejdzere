...
Appointment WordPress Theme, Copyright (C) 2013-2023, priyanshumittal
...
@version 3.3
1.Added Google Fonts Locally Feature.
@version 3.2.9
1. Added freemius code snippet and moved option page submenu into a top-level menu.
@version 3.2.8
